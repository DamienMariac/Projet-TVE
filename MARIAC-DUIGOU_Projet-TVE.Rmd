...
BIC(mod_log,mod_alog,mod_nlog)
```

Plus petit AIC : le modèle logistique négatif avec autant de degrés de liberté donc garder ce modèle (mod_nlog)
...
La fonction de dépendance donne l'intuition qu'il y a une dépendance mais pas excessive. La valeur de alpha est d'environ 0.54 et de theta environ 1.53. Donc il y a dépendance et la "force" de la dépendance est moyenne. 
